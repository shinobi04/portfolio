  ...
  const educationPath: EducationEntry[] = [
    {
      ...
      description: [
        ...
        "Exploring web development, AI/ML, and software engineering principles",
      ],
      skills: [
        "C++",
        "Python",
    ...
    },
    {
      ...
      description: [
        ...
        "Developed problem-solving skills through programming challenges",
      ],
      skills: [
        "Programming Basics",
        "Mathematics",
    ...
    },
    {
      ...
      description: [
        ...
        "First introduction to programming and computer science",
